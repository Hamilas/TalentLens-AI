...
def _default_model() -> AllModelEnum:
    # Deferred import: src.app.core.config imports from src.app.schemas at
    # module load time, so importing settings here at module level would

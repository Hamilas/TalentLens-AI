   ...
   {{
     ...
     "timeline": [
       {{
         ...
         "summary": "<one sentence describing what was actually asked and answered in THIS segment>",
         "confidence_score": 0.9
       }}
     ],
     "overall_sentiment": "Positive",
     "key_topics": ["<real topic discussed>", "<another real topic discussed>"],
     "total_duration": "<the timestamp of the LAST event in the transcript, e.g. 00:02:15 — never a made-up or example value>"
   }}
   ```

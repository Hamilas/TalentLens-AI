...
def sentiment_analyzer_func(text: str) -> str:
    ...
    positive_keywords = [
        ...
        "impressed", "impressive", "love", "fantastic", "wonderful", "brilliant",
        "solved", "successful", "achieved", "accomplished", "clear",
        "strong", "solid", "well done", "nice job"
    ]
    ...
    negative_keywords = [
        ...
        "concerning", "concerned", "weak", "lacking"
    ]
    ...
    for sentence in sentences:
        ...
        if len(sentence) < 8:  # Skip empty/near-empty fragments
            continue

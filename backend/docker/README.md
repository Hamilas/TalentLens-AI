# Docker Configuration for TalentLens-AI

This directory contains Docker configurations for different environments of the TalentLens-AI backend application.
...
### Database Names
- **Development**: Uses `talentlens_dev_db` database
- **Testing**: Uses `talentlens_test_db` database (isolated)
- **Production**: Uses `talentlens_db` database
...
docker exec -it <container-name> psql -U postgres -d talentlens_db
```
